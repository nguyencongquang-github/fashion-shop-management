// src/components/paginationCustomer/PaginationCustomer.jsx
import React, { useState } from 'react';
import './PaginationCustomer.css';
const PaginationCustomer = ({ totalItems, itemsPerPage, onPageChange, onItemsPerPageChange }) => {
    ...
    return (
        <div className="pagination-customer-container">
            <div className="pagination-customer-left">
            ...
            <div className="pagination-customer-right">
