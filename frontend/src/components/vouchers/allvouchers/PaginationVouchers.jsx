// src/components/paginationVoucher/PaginationVoucher.jsx
import React, { useState } from 'react';
import './PaginationVoucher.css';
const PaginationVoucher = ({ totalItems, itemsPerPage, onPageChange, onItemsPerPageChange }) => {
    ...
    return (
        <div className="pagination-voucher-container">
            <div className="pagination-voucher-left">
            ...
            <div className="pagination-voucher-right">
