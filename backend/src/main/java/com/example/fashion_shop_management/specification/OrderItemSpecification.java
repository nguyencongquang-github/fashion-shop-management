...
public class OrderItemSpecification {
    ...
    public static Specification<OrderItem> createDateBetween(LocalDateTime start, LocalDateTime end) {
    ...
    public static Specification<OrderItem> hasProductId(Integer productId) {
